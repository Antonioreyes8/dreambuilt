...
// =========================================================================
// DYNAMIC ASSET IMPORTS FOR SECTIONS 4 & 5
// =========================================================================
const northBluffImages = Object.values(
    import.meta.glob("../assets/northbluff/*.{png,jpg,jpeg,webp,svg}", {
        eager: true,
        import: "default",
    })
) as string[];

const duchessImages = Object.values(
    import.meta.glob("../assets/duchess/*.{png,jpg,jpeg,webp,svg}", {
        eager: true,
        import: "default",
    })
) as string[];

const sanJacintoImages = Object.values(
    import.meta.glob("../assets/sanjacinto/*.{png,jpg,jpeg,webp,svg}", {
        eager: true,
        import: "default",
    })
) as string[];

// Dynamic background banner selection for Section 5
const bannerBgSrc = northBluffImages[0] || duchessImages[0] || sanJacintoImages[0] || "";
