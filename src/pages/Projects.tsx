...
// Dynamically load image paths from src/assets folders
...
export default function Projects() {
    ...
    // Master Data Matrix reflecting all projects and local image assets
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 pt-4 border-t border-neutral-200">
                                        {project.images.map((imgUrl, imgIdx) => (
                                            ...
                                            >
                                                <img
                                                    src={imgUrl}
                                                    alt={`${project.name} construction view ${imgIdx + 1}`}
